...
const product = {
  ...
  return (
    <main className="w-full max-w-[1600px] mx-auto px-6 lg:px-12 py-12 lg:py-16">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-10 lg:gap-16 items-start">
        <section className="w-full order-2 lg:order-1">
          <div className="border border-stone-800 bg-stone-900 rounded-2xl p-6 mb-8">
          ...
          <div className="w-full overflow-hidden rounded-2xl border border-stone-800 bg-stone-900 mb-8">
            <img
          ...
          <div className="border border-stone-800 bg-stone-900 rounded-2xl p-6 mb-2">
            <h2 className="text-sm uppercase tracking-widest font-semibold text-stone-500 mb-4">
              Description
            </h2>
          ...
          <div className="border border-stone-700 bg-stone-700 rounded-2xl p-6">
